...
public class PetaRuteAsalPage extends AppCompatActivity implements OnMapReadyCallback {
...
//                progressDialog.hide();
                if(status==1){
                    ...
                    Toast.makeText(PetaRuteAsalPage.this, "Koneksi bermasalah", Toast.LENGTH_SHORT).show();
                    finish();
                }
            }
        };
...
//        progressDialog.show();
    ...
    private void setLocation() {
        ...
        myLocation.setLatitude(getIntent().getDoubleExtra("lat_pengguna", 0));
        myLocation.setLongitude(getIntent().getDoubleExtra("lng_pengguna", 0));
        directionLocation.setLatitude(getIntent().getDoubleExtra("lat_asal", 0));
        directionLocation.setLongitude(getIntent().getDoubleExtra("lng_asal", 0));
    }
    ...
    private void setActionBar() {
        ...
        getSupportActionBar().setTitle("Rute Halte Asal");
    }
    ...
    private void setMarker(Location location, int a){
        ...
        if(a==0){
            ...
            markerOptions.position(lokasi_tujuan).title("Halte Asal");
        }
